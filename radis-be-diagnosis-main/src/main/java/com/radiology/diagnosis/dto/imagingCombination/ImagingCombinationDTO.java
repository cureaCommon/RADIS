...
public class ImagingCombinationDTO {
    ...
    public ImagingCombinationDTO(String id, String rating, String adultRRL, String shortJustification, String literatureSummary) {
        this.id = id;
        this.rating = rating;
